      ...
      <div className={styles.servicesContentWrp}>
        ...
        <div className={styles.talent}>
          <div className={styles.talentLeft}>
            ...
            <SolidBtn style={{ marginTop: '24px', width: '100%', textAlign: 'center' }} name={ServicesData.talent[0].button} color="#1C2D80" />
          </div>
        ...
        <div className={styles.teams}>
          ...
          <div className={styles.teamsLeft}>
            ...
            <SolidBtn style={{ marginTop: '24px', width: '100%', textAlign: 'center' }} name={ServicesData.teams[0].button} color="#1C2D80" />
          </div>
        </div>
